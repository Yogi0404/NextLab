...
<body class="bg-gray-100 text-gray-800">
    ...
    <div class="bg-blue-900 text-white px-6 py-4 flex justify-between items-center shadow-lg sticky top-0 z-50">
        ...
        <div>
            ...
            <p class="text-xs text-blue-200">Petugas Panel</p>
        </div>

        <!-- User -->
        <div class="flex items-center gap-3">
            <div class="text-right">
                <p class="text-sm font-medium">Andi Pratama</p>
    ...
    <div class="bg-white border-b px-6 py-2 flex gap-6 text-sm overflow-x-auto">
        ...
        <a href="/petugasdashboard"
            class="pb-2 border-b-2 transition
            {{ request()->is('petugasdashboard')
        ...
        <a href="/logout"
            class="pb-2 border-b-2 transition text-red-500 hover:text-red-700">
            Logout
        </a>
